...
blob_fixups: blob_fixups_user_type = {
    ...
    ('system_ext/lib/com.qualcomm.qti.ant@1.0.so', 'system_ext/lib64/com.qualcomm.qti.ant@1.0.so', 'vendor/lib64/vendor.qti.hardware.scve.objecttracker@1.0.so', 'vendor/lib64/vendor.qti.hardware.sensorscalibrate@1.0.so', 'vendor/lib64/vendor.qti.hardware.iop@1.0.so', 'vendor/lib64/com.qualcomm.qti.ant@1.0.so', 'vendor/lib64/vendor.qti.hardware.tui_comm@1.0.so', 'vendor/lib64/vendor.qti.hardware.factory@1.0.so', 'vendor/lib64/vendor.qti.hardware.qteeconnector@1.0.so', 'vendor/lib64/vendor.qti.hardware.iop@2.0.so', 'vendor/lib64/vendor.qti.esepowermanager@1.0.so', 'vendor/lib64/vendor.qti.hardware.scve.panorama@1.0.so', 'vendor/lib/vendor.qti.hardware.scve.objecttracker@1.0.so', 'vendor/lib/vendor.qti.hardware.sensorscalibrate@1.0.so', 'vendor/lib/vendor.qti.hardware.iop@1.0.so', 'vendor/lib/com.qualcomm.qti.ant@1.0.so,' 'vendor/lib/vendor.qti.hardware.tui_comm@1.0.so', 'vendor/lib/vendor.qti.hardware.factory@1.0.so', 'vendor/lib/vendor.qti.hardware.qteeconnector@1.0.so', 'vendor/lib/vendor.qti.hardware.iop@2.0.so', 'vendor/lib/vendor.qti.esepowermanager@1.0.so', 'vendor/lib/vendor.qti.hardware.scve.panorama@1.0.so'): blob_fixup()
        .replace_needed('libhidlbase.so', 'libhidlbase-v32.so'),
}  # fmt: skip
