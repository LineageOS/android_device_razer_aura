...
$(SECUREFS_MOUNT_POINT): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating $(SECUREFS_MOUNT_POINT)"
	@mkdir -p $(TARGET_OUT_VENDOR)/securefs

ALL_DEFAULT_INSTALLED_MODULES += $(FIRMWARE_MOUNT_POINT) $(BT_FIRMWARE_MOUNT_POINT) $(DSP_MOUNT_POINT) $(SECUREFS_MOUNT_POINT)
...
$(RFS_MSM_MPSS_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	...
	$(hide) ln -sf /vendor/firmware_mnt $@/readonly/firmware
	$(hide) ln -sf /vendor/firmware $@/readonly/vendor/firmware
	$(hide) ln -sf /data/misc/fih_atl $@/fih_rfs/data/misc/fih_atl
	$(hide) ln -sf /data/misc/fih_mcfg $@/fih_rfs/data/misc/fih_mcfg
