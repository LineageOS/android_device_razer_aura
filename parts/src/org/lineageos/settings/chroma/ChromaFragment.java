...
public class ChromaFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    static final String KEY_ENABLED         = "chroma_enabled";
    static final String KEY_SUSPEND_ON_SLEEP = "chroma_suspend_on_sleep";
    static final String KEY_MODE            = "chroma_mode";
    static final String KEY_COLOR           = "chroma_color";
    static final String KEY_BRIGHTNESS      = "chroma_brightness";
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (KEY_BRIGHTNESS.equals(preference.getKey())) {
            int brightness = 200;
            try { brightness = Integer.parseInt((String) newValue); } catch (NumberFormatException ignored) {}
    ...
    private void updateSummaries() {
        ...
        mBrightnessPref.setSummary(String.valueOf(prefs.getInt(KEY_BRIGHTNESS, 200)));
    }
}
